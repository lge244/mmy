...
<div class="fui-header">
	...
	<div class="title"><?php  if(!empty($page)&&!empty($page['data']['page']['title'])) { ?><?php  echo $page['data']['page']['title'];?><?php  } else { ?><?php  echo $_W['shopset']['shop']['name'];?><?php  } ?>
	</div>
...
<div class="fui-content <?php  if($page['diymenu']>-1) { ?>navbar<?php  } ?>" id="container"
     style="background-color: <?php  echo $page['data']['page']['background'];?>; <?php  if($page['diymenu']>-1) { ?>padding-bottom: 0;<?php  } ?>">
	<?php  if($diy_topmenu) { ?>
