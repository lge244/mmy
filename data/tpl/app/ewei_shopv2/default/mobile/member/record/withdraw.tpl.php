...
<div class="fui-page-group ">
    ...
    <div class='fui-content member-page navbar'>
        <div class="list">
            <ul class="head-title">
                <li class="head-li">姓名</li>
                <li class="head-li">账户</li>
            ...
            <ul class="content">
                <li class="date"><?php  echo $row['username'];?></li>
                <li class="date"><?php  echo $row['account'];?></li>
                <li class="number"><?php  echo $row['money'];?></li>
                <li class="operate"><?php  if(($row['type'] == 0)) { ?> <span style="color: #495066">未审核</span> <?php  } else { ?> <?php  if(($row['type'] == 1)) { ?> <span style="color: #00cccc">未审核</span> <?php  } else { ?> <span style="color: red">已驳回</span> <?php  } ?> <?php  } ?></li>
                <li class="user"><?php  echo date('Y-m-d',$row['withdraw_time'])?></li>
            </ul>
            <?php  } } ?>
        </div>
    </div>
