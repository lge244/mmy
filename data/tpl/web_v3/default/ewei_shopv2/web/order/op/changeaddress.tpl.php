...
<form class="form-horizontal form-validate" action="<?php  echo webUrl('order/op/changeaddress')?>" method="post" enctype="multipart/form-data">
           ...
           <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group ad-group"  style="display: none;">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <span class="help-block"><?php  echo $user['address'];?></span>
                    </div>
                </div>
                ...
                <div class="form-group ad-group" style="display: none;">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <p>
                            ...
                            <select id="sel-street" name="street" class="select form-control select-group" style="width:220px;display:inline;margin-top: 10px;">
                                <option value="" selected="true">请选择</option>
                            </select>
                            <?php  } ?>
                        </p>
