...
<div class="page-header">
    ...
    <button style="float: right; background: #0A8CD2; color: white; width: 50px;" onclick="doPrint()">打印订单</button>
</div>
<div class="page-content">
    ...
    "><i class='fa fa-question-circle'></i></a></span>
                            ...
                            <li class="text">
                                ...
                                <span class="col-sm">买家：</span>
                                <span class="text-default">
                                    <a  target='_blank' class="text-primary"><?php  echo $member['nickname'];?></a> &nbsp;&nbsp;<a data-toggle='popover' data-html='true' data-trigger='hover' data-placement='right'
                                                                                                                                                                                               data-content="<table style='width:100%;'>
                    <tr>
                        <td  style='border:none;text-align:right;' colspan='2'><img src='<?php  echo $member['avatar'];?>' style='width:100px;height:100px;padding:1px;border:1px solid #ccc'  onerror='this.src='../addons/ewei_shopv2/static/images/noface.png''/></td>
                    </tr>
    ...
    "><i class='icow icow-help' style="font-size: 13px;color: #2f3434;margin-left: -3px"></i></a>
        ...
        <table class="table ">
            ...
            <tr class="trorder" style="background: #fff">
                ...
                <td >
                    <a  style="display: block;line-height: 22px;max-width: 250px;white-space: nowrap;
        overflow: hidden;text-overflow: ellipsis;"><?php  echo $goods['title'];?></a>
